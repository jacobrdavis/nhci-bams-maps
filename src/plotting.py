...
default_drifter_colors = {
    'microswift': 'rebeccapurple',
    'spotter': 'goldenrod',
    'dwsd': 'dodgerblue',
    'submersible': 'darkorange',
}
...
def get_drifter_map_kwargs(drifter_type: str) -> dict:
    """ Return drifter plot keyword arguments """
    if drifter_type == 'spotter':
        return spotter_map_kwargs
    elif drifter_type == 'microswift':
        return microswift_map_kwargs
    elif drifter_type == 'dwsd':
        return dwsd_map_kwargs
    else:
        raise ValueError(f"No map kwargs for {drifter_type}.")
...
default_border_kwargs = {'edgecolor': 'grey', 'linewidth': 0.5, 'alpha': 0.25, 'zorder': 4}
...
def plot_base_chart(
    ...
    border_kwargs=default_border_kwargs,
    ...
    border_kwargs = _set_kwarg_defaults(default_border_kwargs, border_kwargs)
...
def plot_minimap(
    ...
    ax_inset.add_feature(cartopy.feature.BORDERS, **border_kwargs)
